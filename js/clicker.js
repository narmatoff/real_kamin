...
// console.table($(this).serialize());
 ...
 $(".outnstock").fancybox({
            ...
            tovarname = $(this.element).attr('data-tovarname');
            $.ajax({
                ...
                success: function (data) {
                    ...
                    text_after = '<input name="data[new][tovar]" type="hidden" value="' + id + '"><input name="data[new][cena]" type="hidden" value="' + price + '"><input name="data[new][artikul]" type="hidden" value="' + article + '"><input name="data[new][tovarname]" type="hidden" value="' + tovarname + '">';
                // alert (test);
